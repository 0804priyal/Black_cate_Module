...
define([
    ...
    return Component.extend({
        ...
        saveNewAddress: function () {
            ...
            /*codes for vatvalidator*/
            var url = window.location.href;
            url = url.replace("checkout", "vatvalidator/address/vat");
            var validate = 0;

            var vat =  this.source.get('shippingAddress.vat_id');
            var country =  this.source.get('shippingAddress.country_id');
